  ...
  return (
    <div className="PrivacyPolicy-Container">
      ...
      <p>
        ...
        Burd's Eye Review and how we use it.
      </p>
      ...
      <p>
        Burd's Eye Review follows a standard procedure of using log files. These
      ...
      <p>
        ...
        advertising partners of Burd's Eye Review.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on Burd's Eye Review, which are
      ...
      <p>
        Note that Burd's Eye Review has no access to or control over these
      ...
      <p>
        Burd's Eye Review's Privacy Policy does not apply to other advertisers
      ...
      <p>
        Burd's Eye Review does not knowingly collect any Personal Identifiable
      ...
      <p>
        ...
        shared and/or collect in Burd's Eye Review. This policy is not
